...
/**
 * Write a description of class CalculatorMethods here.
 *
 * @author (Betty J Chism   )
...
public class CalculatorMethods
{
   ...
   public static void main (String[] args)
   {
       ...
       // without needing "x" as s temporary variable in between.
       ...
       // print statements tot est that it works right.
       
             
       System.out.println("3 divide 2 equals" +divide(3, 2));
       System.out.println("10 divide 10 equals" +divide(10,10)); 
